        ...
        <div>
         ...
         {arrayJogos.map(function(obj, i){
          ...
          <div key={i} className='lista-jogos'>
            <ul>
                <li className="titulo">{obj.nome}</li>
                <li className="preco">R${obj.preco}</li>
                <li className="genero">
                  {
                ...
                <li className="ultima-coluna"><div className='icones-fim'><span className="material-icons-round caneta" onClick={()=>{ setEditarJogo('show'); setIdJogo(obj.id) }} >edit</span><span onClick={() => removerItem(obj.id)} className="material-icons-round lixeira">delete</span></div></li>
            </ul>
          </div>
          ); 
         })}
