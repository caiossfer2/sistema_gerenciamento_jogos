       ...
       {arrayJogos.map(function(obj, i){
        ...
        <div key={i} className='lista-jogos'>
          <ul>
              ...
              <li className='ultima-coluna'><div className='icones-fim  visibilidade-hidden'><span className="material-icons-round caneta">edit</span><span className="material-icons-round lixeira">delete</span></div></li>
          </ul>
        </div>
        ); 
       })}
